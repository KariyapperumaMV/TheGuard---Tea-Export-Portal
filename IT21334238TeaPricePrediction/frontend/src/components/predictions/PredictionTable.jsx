      ...
      <tbody>
        {data.map((prediction, idx) => (
          <tr key={idx} className="hover:bg-gray-50">
            ...
            <td className="border border-gray-300 p-2">{prediction.predicted_price}</td>
            <td className="border border-gray-300 p-2">{prediction.lower_bound}</td>
            <td className="border border-gray-300 p-2">{prediction.upper_bound}</td>
          </tr>
        ))}
      </tbody>
    </table>
